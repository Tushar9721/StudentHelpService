  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    private void recordMessage() {
        if (listening != true) {
            ...
            listening = true;
            btnRecord.setBackground(getResources().getDrawable(R.drawable.ic_microphone_click));
            ...
            try {
                ...
                listening = false;
                btnRecord.setBackground(getResources().getDrawable(R.drawable.ic_microphone));
